    ...
    <Grid container direction='column'>
        ...
        <Grid item container direction='column' lg style={{ maxWidth: '40em' }}>
          ...
          <Grid item>
            <Typography variant='body1' align='justify' paragraph>
              The raise of computers, and subsequently the Internet, has
      ...
      <Grid
        ...
        <Grid item container direction='column' lg style={{ maxWidth: '40em' }}>
          ...
          <Grid item>
            ...
            <Typography variant='body1' align='justify' paragraph>
              Two years later they shocked the world by releasing an similar
      ...
      <ProcessBlock
        ...
        paragraphs={[
          ...
          "Then it's time for us to start on your minimum viable product.That's just a fancy terms for a mockup, which doesn't include colors, images, or any polished design elements, but capture the essential layout structure and functionality.",
      ...
      <ProcessBlock
        ...
        paragraphs={[
          ...
          'We give you an interactive demonstration of the mockups, thoroughly explaining the thought process that went into each screen and every anticipated future.',
          "Once you're completely satisfied with the vision for our solution we get down the nitty gritty, fine-details of design."
        ]}
      />
      <ProcessBlock
      ...
      <ProcessBlock
        ...
        paragraphs={[
          ...
          "When construction comes to a close you're the first one to know, We'll give our final demonstration to show off your shiny new software in the sild so you know exactly how it will look to your users.",
